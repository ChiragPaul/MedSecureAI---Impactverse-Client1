...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$MedSecureAI$2d2d2d$Impactverse$2d$Client1$2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/MedSecureAI---Impactverse-Client1/frontend/node_modules/axios/lib/axios.js [app-client] (ecmascript)");
...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$MedSecureAI$2d2d2d$Impactverse$2d$Client1$2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("https://medsecureai-impactverse-1.onrender.com/api/auth/login", {
                email,
                password,
                role
            });
            ...
            alert("❌ " + (((_err_response = err.response) === null || _err_response === void 0 ? void 0 : (_err_response_data = _err_response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.message) || "Login error"));
        }
    };
...
_s(LoginPage, "CQdzuuM5rfMjtvYWzmNu/b5fo6o=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_MedSecureAI---Impactverse-Client1_frontend_app_log-att_login_bb8404bb.js.map